import imgs_1 from '@/assets/foto/Arxiologik_1.png'
import imgs_2 from '@/assets/foto/Arxiologik_2.png'
import imgs_3 from '@/assets/foto/Arxiologik_3.png'
import imgs_4 from '@/assets/foto/Arxiologik_4.png'
const videoLink = '<iframe width="1056" height="600" src="https://www.youtube.com/embed/b1-JHKQ5GVU?list=RDb1-JHKQ5GVU" title="ЭТИ ДУШЕВНЫЕ ПЕСНИ УБЬЮТ ТВОЁ СЕРДЦЕ / 16D МУЗЫКА 🦃™️" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
export default
[
  {
    ...
    carouselFoto: [
      ...
      {
        title: 'quae ab illo inventore veritatis',
        imgs: imgs_2,
        id: 5
      },
