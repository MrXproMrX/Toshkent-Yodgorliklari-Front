<template>
  <section>
    ...
    <MemoriyItem :title="$t('aboutUs')"></MemoriyItem>
    ...
    <div class="ashyolar_content">
      <section class="container">
        <div class="ashyolar_content__cart">
          <div class="ashyolar_content__text clearfix">
            <p>
            ...
            <img src="@/assets/foto/about.png" alt="ashyolar_content">
            <p>
            ...
            <section class="memoriy_video__img__item" :class="{active__video:videoPlay}">
              ...
              <template v-if="videoPlay">
                <div>
                  ...
                  title="ЭТИ ДУШЕВНЫЕ ПЕСНИ УБЬЮТ ТВОЁ СЕРДЦЕ / 16D МУЗЫКА 🦃™️"
                  frameborder="0"
